package com.example.game_endterm_final.thirdGame;
...
public class ThiredGame extends Application {
    private HashMap<KeyCode, Boolean> keys = new HashMap<>();
    public static ArrayList<Rectangle> bonuses = new ArrayList<>();
    Image image = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/1.png")));
